...
final class Version20190412103435 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE x_main.a_achievement (id INT GENERATED ALWAYS AS IDENTITY, uuid UUID NOT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8DCC3731D17F50A6 ON x_main.a_achievement (uuid)');
        $this->addSql('CREATE TABLE x_main.a_photo_upload_achievement (id INT NOT NULL, survey_id INT NOT NULL, uuid UUID NOT NULL, threshold SMALLINT NOT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id)) INHERITS (x_main.a_achievement)');
        ...
        $this->addSql('CREATE TABLE x_main.a_result (id INT NOT NULL, user_id INT NOT NULL, achievement_id INT NOT NULL, uuid UUID NOT NULL, count SMALLINT NOT NULL, is_completed BOOLEAN NOT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_50416C64D17F50A6 ON x_main.a_result (uuid)');
        ...
        $this->addSql('CREATE TABLE x_main.a_survey_completion_achievement (id INT NOT NULL, survey_category_id INT NOT NULL, zone_id INT DEFAULT NULL, uuid UUID NOT NULL, threshold SMALLINT NOT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id)) INHERITS (x_main.a_achievement)');
